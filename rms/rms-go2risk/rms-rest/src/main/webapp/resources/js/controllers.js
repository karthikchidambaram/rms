...
app.controller('AuthCtrl', function ($scope, $http, TokenStorage) {
	...
	$scope.init = function () {
		$http.get('/p/api/users/current').success(function (user) {
	...
	$scope.login = function () {
		alert("Inside login action.");
		$http.post('/p/api/login', { username: $scope.username, password: $scope.password }).success(function (result, status, headers) {
			$scope.authenticated = true;
