 ...
 */
@Repository
public class AccidentLocationDaoImpl extends AbstractHibernateDao<String, AccidentLocation>
		implements AccidentLocationDao {
	...
	public List<AccidentLocation> get() {
		return (List<AccidentLocation>) applySearch(
