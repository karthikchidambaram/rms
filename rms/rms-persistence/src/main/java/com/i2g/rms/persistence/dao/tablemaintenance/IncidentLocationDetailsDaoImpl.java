 ...
 */
@Repository
public class IncidentLocationDetailsDaoImpl extends AbstractHibernateDao<String, IncidentLocationDetails> implements IncidentLocationDetailsDao {

	private final Logger _logger = LoggerFactory.getLogger(IncidentLocationDetailsDaoImpl.class);

	@Autowired
	private HibernateTemplate _hibernateTemplate;

	/**
	 * Creates a new instance of {@link IncidentLocationDetailsDaoImpl}.
	 */
	private IncidentLocationDetailsDaoImpl() {
		super(IncidentLocationDetails.class);
	}
	...
	public List<IncidentLocationDetails> get() {
		return (List<IncidentLocationDetails>) applySearch(getSession().createCriteria(_modelType)).list();
	}
	...
	public IncidentLocationDetails getByCode(final String code) {
		...
		validateCode(code);
		return (IncidentLocationDetails) applySearch(getSession().createCriteria(_modelType)
	...
	public IncidentLocationDetails create(final String code, final String description) {
		...
		IncidentLocationDetails object = new IncidentLocationDetails(code, description);
		// Issue save
		save(object);
		return object;
	}
	...
	public IncidentLocationDetails update(final String code, final String description) {
		...
		IncidentLocationDetails object = getByCode(code);
