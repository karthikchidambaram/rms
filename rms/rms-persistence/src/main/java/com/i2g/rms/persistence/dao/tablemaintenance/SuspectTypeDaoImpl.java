 ...
 */
@Repository
public class SuspectTypeDaoImpl extends AbstractHibernateDao<String, SuspectType> implements SuspectTypeDao {

	private final Logger _logger = LoggerFactory.getLogger(SuspectTypeDaoImpl.class);

	@Autowired
	private HibernateTemplate _hibernateTemplate;

	/**
	 * Creates a new instance of {@link SuspectTypeDaoImpl}.
	 */
	private SuspectTypeDaoImpl() {
		super(SuspectType.class);
	}
	...
	public List<SuspectType> get() {
		return (List<SuspectType>) applySearch(getSession().createCriteria(_modelType)).list();
	}
	...
	public SuspectType getByCode(final String code) {
		...
		validateCode(code);
		return (SuspectType) applySearch(getSession().createCriteria(_modelType)
	...
	public SuspectType create(final String code, final String description) {
		...
		SuspectType object = new SuspectType(code, description);
		// Issue save
		save(object);
		return object;
	}
	...
	public SuspectType update(final String code, final String description) {
		...
		SuspectType object = getByCode(code);
