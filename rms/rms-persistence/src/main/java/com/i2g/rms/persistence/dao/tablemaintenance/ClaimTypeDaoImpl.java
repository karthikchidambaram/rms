 ...
 */
@Repository
public class ClaimTypeDaoImpl extends AbstractHibernateDao<String, ClaimType> implements ClaimTypeDao {

	private final Logger _logger = LoggerFactory.getLogger(ClaimTypeDaoImpl.class);

	@Autowired
	private HibernateTemplate _hibernateTemplate;

	/**
	 * Creates a new instance of {@link ClaimTypeDaoImpl}.
	 */
	private ClaimTypeDaoImpl() {
	...
	public List<ClaimType> get() {
		return (List<ClaimType>) applySearch(getSession().createCriteria(_modelType)).list();
	}
	...
	public ClaimType getByCode(final String code) {
		...
		validateCode(code);
		return (ClaimType) applySearch(getSession().createCriteria(_modelType)
	...
	public ClaimType create(final String code, final String description) {
		...
		ClaimType object = new ClaimType(code, description);
		// Issue save
		save(object);
		return object;
	}
	...
	public ClaimType update(final String code, final String description) {
		...
		ClaimType object = getByCode(code);
