 ...
 */
@Repository
public class DistinguishingFeaturesDetailDaoImpl extends AbstractHibernateDao<String, DistinguishingFeaturesDetail> implements DistinguishingFeaturesDetailDao {

	private final Logger _logger = LoggerFactory.getLogger(DistinguishingFeaturesDetailDaoImpl.class);

	@Autowired
	private HibernateTemplate _hibernateTemplate;

	/**
	 * Creates a new instance of {@link DistinguishingFeaturesDetailDaoImpl}.
	 */
	private DistinguishingFeaturesDetailDaoImpl() {
		super(DistinguishingFeaturesDetail.class);
	}
	...
	public List<DistinguishingFeaturesDetail> get() {
		return (List<DistinguishingFeaturesDetail>) applySearch(getSession().createCriteria(_modelType)).list();
	}
	...
	public DistinguishingFeaturesDetail getByCode(final String code) {
		...
		validateCode(code);
		return (DistinguishingFeaturesDetail) applySearch(getSession().createCriteria(_modelType)
	...
	public DistinguishingFeaturesDetail create(final String code, final String description) {
		...
		DistinguishingFeaturesDetail object = new DistinguishingFeaturesDetail(code, description);
		// Issue save
		save(object);
		return object;
	}
	...
	public DistinguishingFeaturesDetail update(final String code, final String description) {
		...
		DistinguishingFeaturesDetail object = getByCode(code);
