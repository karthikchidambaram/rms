...
public class DistinguishingFeatureDaoImpl extends AbstractHibernateDao<String, DistinguishingFeature> implements DistinguishingFeatureDao {
	...
	/**
	 * Creates a new instance of {@link DistinguishingFeatureDaoImpl}.
	 */
	private DistinguishingFeatureDaoImpl() {
		super(DistinguishingFeature.class);
	}
	...
	public DistinguishingFeature getByCode(final String code) {
		...
		validateCode(code);
		return (DistinguishingFeature) applySearch(getSession().createCriteria(_modelType)
	...
	public DistinguishingFeature create(final String code, final String description) {
		...
		DistinguishingFeature object = new DistinguishingFeature(code, description);
		// Issue save
		save(object);
		return object;
	}
