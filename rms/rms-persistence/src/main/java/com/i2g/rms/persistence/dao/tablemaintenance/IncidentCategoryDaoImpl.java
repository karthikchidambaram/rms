 ...
 */
@Repository
public class IncidentCategoryDaoImpl extends AbstractHibernateDao<String, IncidentCategory> implements IncidentCategoryDao {

	private final Logger _logger = LoggerFactory.getLogger(IncidentCategoryDaoImpl.class);

	@Autowired
	private HibernateTemplate _hibernateTemplate;

	/**
	 * Creates a new instance of {@link IncidentCategoryDaoImpl}.
	 */
	private IncidentCategoryDaoImpl() {
	...
	public List<IncidentCategory> get() {
		return (List<IncidentCategory>) applySearch(getSession().createCriteria(_modelType)).list();
	}
	...
	public IncidentCategory getByCode(final String code) {
		...
		validateCode(code);
		return (IncidentCategory) applySearch(getSession().createCriteria(_modelType)
	...
	public IncidentCategory create(final String code, final String description) {
		...
		IncidentCategory object = new IncidentCategory(code, description);
		// Issue save
		save(object);
		return object;
	}
	...
	public IncidentCategory update(final String code, final String description) {
		...
		IncidentCategory object = getByCode(code);
