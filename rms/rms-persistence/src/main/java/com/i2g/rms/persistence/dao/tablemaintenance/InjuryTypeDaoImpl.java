 ...
 */
@Repository
public class InjuryTypeDaoImpl extends AbstractHibernateDao<String, InjuryType> implements InjuryTypeDao {

	private final Logger _logger = LoggerFactory.getLogger(InjuryTypeDaoImpl.class);

	@Autowired
	private HibernateTemplate _hibernateTemplate;

	/**
	 * Creates a new instance of {@link InjuryTypeDaoImpl}.
	 */
	private InjuryTypeDaoImpl() {
		super(InjuryType.class);
	}
	...
	public List<InjuryType> get() {
		return (List<InjuryType>) applySearch(getSession().createCriteria(_modelType)).list();
	}
	...
	public InjuryType getByCode(final String code) {
		...
		validateCode(code);
		return (InjuryType) applySearch(getSession().createCriteria(_modelType)
	...
	public InjuryType create(final String code, final String description) {
		...
		InjuryType object = new InjuryType(code, description);
		// Issue save
		save(object);
		return object;
	}
	...
	public InjuryType update(final String code, final String description) {
		...
		InjuryType object = getByCode(code);
