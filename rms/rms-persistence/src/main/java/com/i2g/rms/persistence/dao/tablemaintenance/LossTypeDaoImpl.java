 ...
 */
@Repository
public class LossTypeDaoImpl extends AbstractHibernateDao<String, LossType> implements LossTypeDao {

	private final Logger _logger = LoggerFactory.getLogger(LossTypeDaoImpl.class);

	@Autowired
	private HibernateTemplate _hibernateTemplate;

	/**
	 * Creates a new instance of {@link LossTypeDaoImpl}.
	 */
	private LossTypeDaoImpl() {
		super(LossType.class);
	}
	...
	public List<LossType> get() {
		return (List<LossType>) applySearch(getSession().createCriteria(_modelType)).list();
	}
	...
	public LossType getByCode(final String code) {
		...
		validateCode(code);
		return (LossType) applySearch(getSession().createCriteria(_modelType)
	...
	public LossType create(final String code, final String description) {
		...
		LossType object = new LossType(code, description);
		// Issue save
		save(object);
		return object;
	}
	...
	public LossType update(final String code, final String description) {
		...
		LossType object = getByCode(code);
