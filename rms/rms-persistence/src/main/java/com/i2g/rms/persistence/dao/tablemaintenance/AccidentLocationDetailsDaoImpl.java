 ...
 */
@Repository
public class AccidentLocationDetailsDaoImpl extends AbstractHibernateDao<String, AccidentLocationDetails> implements AccidentLocationDetailsDao {

	private final Logger _logger = LoggerFactory.getLogger(AccidentLocationDetailsDaoImpl.class);

	@Autowired
	private HibernateTemplate _hibernateTemplate;

	/**
	 * Creates a new instance of {@link AccidentLocationDetailsDaoImpl}.
	 */
	private AccidentLocationDetailsDaoImpl() {
		super(AccidentLocationDetails.class);
	}
	...
	public List<AccidentLocationDetails> get() {
		return (List<AccidentLocationDetails>) applySearch(getSession().createCriteria(_modelType)).list();
	}
	...
	public AccidentLocationDetails getByCode(final String code) {
		...
		validateCode(code);
		return (AccidentLocationDetails) applySearch(getSession().createCriteria(_modelType)
	...
	public AccidentLocationDetails create(final String code, final String description) {
		...
		AccidentLocationDetails object = new AccidentLocationDetails(code, description);
		// Issue save
		save(object);
		return object;
	}
	...
	public AccidentLocationDetails update(final String code, final String description) {
		...
		AccidentLocationDetails object = getByCode(code);
