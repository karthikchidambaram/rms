...
public class ClaimRequestRegistrationTypeDaoImpl extends AbstractHibernateDao<String, ClaimRequestRegistrationType> implements ClaimRequestRegistrationTypeDao {
	...
	/**
	 * Creates a new instance of {@link ClaimRequestRegistrationTypeDaoImpl}.
	 */
	private ClaimRequestRegistrationTypeDaoImpl() {
		super(ClaimRequestRegistrationType.class);
	}
	...
	public ClaimRequestRegistrationType getByCode(final String code) {
		...
		validateCode(code);
		return (ClaimRequestRegistrationType) applySearch(getSession().createCriteria(_modelType)
	...
	public ClaimRequestRegistrationType create(final String code, final String description) {
		...
		ClaimRequestRegistrationType object = new ClaimRequestRegistrationType(code, description);
		// Issue save
		save(object);
		return object;
	}
