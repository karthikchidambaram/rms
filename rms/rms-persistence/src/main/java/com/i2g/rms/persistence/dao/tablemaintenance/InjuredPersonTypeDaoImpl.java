 ...
 */
@Repository
public class InjuredPersonTypeDaoImpl extends AbstractHibernateDao<String, InjuredPersonType>
		implements InjuredPersonTypeDao {
	...
	public List<InjuredPersonType> get() {
		return (List<InjuredPersonType>) applySearch(
