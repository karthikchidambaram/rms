 ...
 */
@Repository
public class PolicyTypeDaoImpl extends AbstractHibernateDao<String, PolicyType> implements PolicyTypeDao {

	private final Logger _logger = LoggerFactory.getLogger(PolicyTypeDaoImpl.class);

	@Autowired
	private HibernateTemplate _hibernateTemplate;

	/**
	 * Creates a new instance of {@link PolicyTypeDaoImpl}.
	 */
	private PolicyTypeDaoImpl() {
	...
	public List<PolicyType> get() {
		return (List<PolicyType>) applySearch(getSession().createCriteria(_modelType)).list();
	}
	...
	public PolicyType getByCode(final String code) {
		...
		validateCode(code);
		return (PolicyType) applySearch(getSession().createCriteria(_modelType)
	...
	public PolicyType create(final String code, final String description) {
		...
		PolicyType object = new PolicyType(code, description);
		// Issue save
		save(object);
		return object;
	}
	...
	public PolicyType update(final String code, final String description) {
		...
		PolicyType object = getByCode(code);
