 ...
 */
@Repository
public class EmployeeTypeDaoImpl extends AbstractHibernateDao<String, EmployeeType> implements EmployeeTypeDao {

	private final Logger _logger = LoggerFactory.getLogger(EmployeeTypeDaoImpl.class);

	@Autowired
	private HibernateTemplate _hibernateTemplate;

	/**
	 * Creates a new instance of {@link EmployeeTypeDaoImpl}.
	 */
	private EmployeeTypeDaoImpl() {
	...
	public EmployeeType getByCode(final String code) {
		...
		validateCode(code);
		return (EmployeeType) applySearch(getSession().createCriteria(_modelType)
	...
	public EmployeeType create(final String code, final String description) {
		...
		EmployeeType object = new EmployeeType(code, description);
		// Issue save
		save(object);
		return object;
	}
