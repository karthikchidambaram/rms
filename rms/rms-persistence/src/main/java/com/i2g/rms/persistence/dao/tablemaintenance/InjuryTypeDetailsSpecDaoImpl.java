 ...
 */
@Repository
public class InjuryTypeDetailsSpecDaoImpl extends AbstractHibernateDao<String, InjuryTypeDetailsSpec> implements InjuryTypeDetailsSpecDao {

	private final Logger _logger = LoggerFactory.getLogger(InjuryTypeDetailsSpecDaoImpl.class);

	@Autowired
	private HibernateTemplate _hibernateTemplate;

	/**
	 * Creates a new instance of {@link InjuryTypeDetailsSpecDaoImpl}.
	 */
	private InjuryTypeDetailsSpecDaoImpl() {
		super(InjuryTypeDetailsSpec.class);
	}
	...
	public List<InjuryTypeDetailsSpec> get() {
		return (List<InjuryTypeDetailsSpec>) applySearch(getSession().createCriteria(_modelType)).list();
	}
	...
	public InjuryTypeDetailsSpec getByCode(final String code) {
		...
		validateCode(code);
		return (InjuryTypeDetailsSpec) applySearch(getSession().createCriteria(_modelType)
	...
	public InjuryTypeDetailsSpec create(final String code, final String description) {
		...
		InjuryTypeDetailsSpec object = new InjuryTypeDetailsSpec(code, description);
		// Issue save
		save(object);
		return object;
	}
	...
	public InjuryTypeDetailsSpec update(final String code, final String description) {
		...
		InjuryTypeDetailsSpec object = getByCode(code);
