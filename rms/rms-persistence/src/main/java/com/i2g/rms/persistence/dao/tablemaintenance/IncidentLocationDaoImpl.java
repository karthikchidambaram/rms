 ...
 */
@Repository
public class IncidentLocationDaoImpl extends AbstractHibernateDao<String, IncidentLocation> implements IncidentLocationDao {

	private final Logger _logger = LoggerFactory.getLogger(IncidentLocationDaoImpl.class);

	@Autowired
	private HibernateTemplate _hibernateTemplate;

	/**
	 * Creates a new instance of {@link IncidentLocationDaoImpl}.
	 */
	private IncidentLocationDaoImpl() {
		super(IncidentLocation.class);
	}
	...
	public List<IncidentLocation> get() {
		return (List<IncidentLocation>) applySearch(getSession().createCriteria(_modelType)).list();
	}
	...
	public IncidentLocation getByCode(final String code) {
		...
		validateCode(code);
		return (IncidentLocation) applySearch(getSession().createCriteria(_modelType)
	...
	public IncidentLocation create(final String code, final String description) {
		...
		IncidentLocation object = new IncidentLocation(code, description);
		// Issue save
		save(object);
		return object;
	}
	...
	public IncidentLocation update(final String code, final String description) {
		...
		IncidentLocation object = getByCode(code);
