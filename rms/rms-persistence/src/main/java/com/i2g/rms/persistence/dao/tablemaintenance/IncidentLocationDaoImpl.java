 ...
 */
@Repository
public class IncidentLocationDaoImpl extends AbstractHibernateDao<String, IncidentLocation>
		implements IncidentLocationDao {
	...
	public List<IncidentLocation> get() {
		return (List<IncidentLocation>) applySearch(
