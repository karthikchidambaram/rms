 ...
 */
@Repository
public class ExternalAgencyDaoImpl extends AbstractHibernateDao<String, ExternalAgency> implements ExternalAgencyDao {

	private final Logger _logger = LoggerFactory.getLogger(ExternalAgencyDaoImpl.class);

	@Autowired
	private HibernateTemplate _hibernateTemplate;

	/**
	 * Creates a new instance of {@link ExternalAgencyDaoImpl}.
	 */
	private ExternalAgencyDaoImpl() {
		super(ExternalAgency.class);
	}
	...
	public List<ExternalAgency> get() {
		return (List<ExternalAgency>) applySearch(getSession().createCriteria(_modelType)).list();
	}
	...
	public ExternalAgency getByCode(final String code) {
		...
		validateCode(code);
		return (ExternalAgency) applySearch(getSession().createCriteria(_modelType)
	...
	public ExternalAgency create(final String code, final String description) {
		...
		ExternalAgency object = new ExternalAgency(code, description);
		// Issue save
		save(object);
		return object;
	}
	...
	public ExternalAgency update(final String code, final String description) {
		...
		ExternalAgency object = getByCode(code);
