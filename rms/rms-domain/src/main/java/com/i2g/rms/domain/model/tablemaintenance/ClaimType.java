...
/**
 * Entity for representing allowable values for the drop down "Claim Type" in
...
public class ClaimType extends AbstractDataModel<String> implements Serializable {
	...
	/**
	 * Creates a new instance of {@code ClaimType} with the specified code.
	 * 
	 * @param code
	 */
	public ClaimType(final String code) {
		_id = Objects.requireNonNull(code, "Claim type code cannot be null.");
	}
	 ...
	 * @param description
	 */
	public ClaimType(final String code, final String description) {
		_id = Objects.requireNonNull(code, "Claim type code cannot be null.");
		_description = Objects.requireNonNull(description, "Claim type description cannot be null.");
	}
	...
	public boolean equals(final Object obj) {
		return obj == this || (obj instanceof ClaimType && Objects.equals(_id, ((ClaimType) obj)._id));
	}
