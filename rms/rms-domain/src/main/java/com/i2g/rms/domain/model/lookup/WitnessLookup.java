...
/**
 * Witness lookup entity object based on a view.
 * 
 * @since 1.0.0
 ...
 */
@Entity
@Table(name = "RMS_WITNS_LKUP_VW")
public class WitnessLookup extends AbstractDataModel<Long> implements Serializable {
