...
/**
 * Entity for representing allowable values for the drop down "Incident Category" in
 ...
 */
@Entity
@Table(name = "RMS_INC_CTGRY")
public class IncidentCategory extends AbstractDataModel<String> implements Serializable {
	...
	/**
	 * Creates a new instance of {@code IncidentCategory} with the specified code.
	 * 
	 * @param code
	 */
	public IncidentCategory(final String code) {
		_id = Objects.requireNonNull(code, "Incident category code cannot be null.");
	}
	 ...
	 * @param description
	 */
	public IncidentCategory(final String code, final String description) {
		_id = Objects.requireNonNull(code, "Incident category code cannot be null.");
		_description = Objects.requireNonNull(description, "Incident category description cannot be null.");
	}
