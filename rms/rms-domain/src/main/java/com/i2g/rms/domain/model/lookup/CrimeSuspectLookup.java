...
/**
 * Crime suspect lookup entity object based on a view.
 * 
 * @since 1.0.0
 ...
 */
@Entity
@Table(name = "RMS_CRME_SUSPT_LKUP_VW")
public class CrimeSuspectLookup extends AbstractDataModel<Long> implements Serializable {
