...
/**
 * Injured Person lookup entity object based on a view.
 * 
 * @since 1.0.0
 ...
 */
@Entity
@Table(name = "RMS_INJRD_PRSN_LKUP_VW")
public class InjuredPersonLookup extends AbstractDataModel<Long> implements Serializable {
