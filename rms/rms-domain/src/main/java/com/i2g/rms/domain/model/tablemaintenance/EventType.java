...
/**
 * Entity for representing allowable values for the drop down "Event Type" in
 ...
 */
@Entity
@Table(name = "RMS_EVNT_TYP")
public class EventType extends AbstractDataModel<String> implements Serializable {
	...
	/**
	 * Creates a new instance of {@code EventType} with the specified code.
	 * 
	 * @param code
	 */
	public EventType(final String code) {
		_id = Objects.requireNonNull(code, "Event type code cannot be null.");
	}
	...
	public EventType(final String code, final String description) {
		_id = Objects.requireNonNull(code, "Event type code cannot be null.");
		_description = Objects.requireNonNull(description, "Event type description cannot be null.");
	}
	...
	public boolean equals(final Object obj) {
		return obj == this || (obj instanceof EventType && Objects.equals(_id, ((EventType) obj)._id));
	}
